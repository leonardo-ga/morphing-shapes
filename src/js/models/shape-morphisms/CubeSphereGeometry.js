...
export default class CubeSphereGeometry extends THREE.BufferGeometry {
    ...
    initialize(radius, segments, morphFn) {
        ...
        this.cube = new Float32Array(this.vertsTotal * 3); // basis positions plane,cube
        this.diff = new Float32Array(this.vertsTotal * 3); // difference positions cube sphere
        ...
        this.morph = function morph(t) {
            ...
            for (let i = 0; i < this.positions.length; i++) {
                this.positions[i] = this.cube[i] + this.diff[i] * w;
            }
    ...
    buildPositions(ia, ib, ic, sign) {
        const writeVertex = (x, y, z) => {
            this.cube[ this.ptr + ia ] = x;
            this.cube[ this.ptr + ib ] = y;
            this.cube[ this.ptr + ic ] = z;
